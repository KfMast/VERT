<script lang="ts">
	...
	import { PUB_PLAUSIBLE_URL, PUB_HOSTNAME, PUB_IFRAME_TARGET_ORIGIN } from "$env/static/public";
...
<svelte:head>
	...
	<meta
		name="title"
		content="convert — Free, fast, and awesome file converter"
	/>
	<meta
		name="description"
		content="With convert, you can quickly convert any image, video, audio, and document file. No ads, no tracking, open source, and all processing (other than video) is done on your device."
	/>
